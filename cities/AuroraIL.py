taxdict = {
    ...
    "local_taxes": {
        "sales_tax": 0.08,
        "property_taxes": "Vary based on assessed property value and location within Aurora"
    },
    "other_taxes": {
        "value_added_tax": "Not applicable in the United States.",
        "miscellaneous_local_fees": "May include water, sewer, and other utility fees, which vary by usage and service area"
    }
}