taxdict = {
    ...
    "state_income_tax": "No state income tax in Nevada",
    "local_taxes": {
        "sales_tax": 0.0838,
        "property_tax": "Varies based on assessed property value and location within Las Vegas",
        "other_local_taxes": "No additional local income taxes"
    },
    "other_federal_taxes": {
        "social_security_tax": "6.2% on the first $147,000 of earnings",
        "medicare_tax": "1.45% on all earnings",
        "self_employment_tax": "15.3% on net earnings from self-employment"
    }
}