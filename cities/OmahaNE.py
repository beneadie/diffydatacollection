taxdict = {
    ...
    "other_taxes": {
        "social_security_tax": "6.2% on the first $147,000 of earnings (funded equally by employee and employer)",
        "medicare_tax": "1.45% on all earnings (funded equally by employee and employer)",
        "vat": "Not applicable in the United States"
    },
    "local_income_tax": {
        "note": "No additional local income taxes in Omaha"
    }
}